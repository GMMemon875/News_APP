...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <Link  className="navbar-brand text-white" to="/home"> <h3>News Hub</h3></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav ms-auto mb-2 mb-lg lg-0">
        ...
        <li className="nav-item">
          <Link  className="nav-link text-white" aria-current="page" to="/sports">Spots</Link>
        </li>
        ...
        <li className="nav-item">
          <Link  className="nav-link text-white" aria-current="page" to="/general">Gerenal</Link>
        </li>
